...
axios.get('https://api.github.com/users/benjamin-forrest')
.then(resp => {
  const gitObj = {
...
const followersArray = ['TopCodeBeast', 'snowwhite-boss', 'JCSime', 'tosuak', 'Marcel-rodriguez', 'MandyIncognito'];

function getFriendsInfo(array){
  axios.get(`https://api.github.com/users/benjamin-forrest/followers`)
  .then(resp => {
